...
CREATE TABLE "ShipReview" (
    ...
    CONSTRAINT "ShipReview_subjectId_fkey" FOREIGN KEY ("subjectId") REFERENCES "Ship" ("id") ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT "ShipReview_reviewerId_fkey" FOREIGN KEY ("reviewerId") REFERENCES "Renter" ("userId") ON DELETE CASCADE ON UPDATE CASCADE,
...
CREATE TABLE "HostReview" (
    ...
    "reviewerId" TEXT NOT NULL,
    "bookingId" TEXT NOT NULL,
    CONSTRAINT "HostReview_subjectId_fkey" FOREIGN KEY ("subjectId") REFERENCES "Host" ("userId") ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT "HostReview_reviewerId_fkey" FOREIGN KEY ("reviewerId") REFERENCES "Renter" ("userId") ON DELETE CASCADE ON UPDATE CASCADE,
