...
We've already got a <InlineFile file="app/utils/env.server.ts" /> file which is
...
global variable, and the <InlineFile file="app/entry.server.tsx" line="13" />
file handles setting these variables globally on the server.
  ...
  <div id="files">
    <ul>
      <li data-state="modified">
        ...
        <InlineFile file="app/entry.client.tsx" />
      </li>
