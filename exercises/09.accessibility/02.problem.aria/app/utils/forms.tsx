...
export function ErrorList({
	...
	errors?: ListOfErrors
	// 🐨 make this prop required because accessibility is not optional 😘
	id?: string
}) {
...
export function Field({
	...
	// 🐨 generate the errorId which should be either ${id}-error or undefined (if there are no errors)
	return (
		<div className={clsx(styles.field, className)}>
			<input
				id={id}
				// 🐨 set aria-invalid to "true" if there are errors and undefined if they are not
				// 🐨 set aria-describedby to the errorId
				placeholder=" "
				{...inputProps}
			...
			<div className="px-4 pt-1 pb-3">
				{/* 🐨 pass the errorId as the id prop to the ErrorList */}
